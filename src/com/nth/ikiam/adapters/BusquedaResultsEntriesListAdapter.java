 ...
 */
public class BusquedaResultsEntriesListAdapter extends ArrayAdapter<Entry> {
    private final Context context;
    private final List<Entry> entries;

    public BusquedaResultsEntriesListAdapter(Context context, List<Entry> entries) {
        super(context, R.layout.busqueda_results_row, entries);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Especie especie = entry.getEspecie(context);
